...
var require_ReactElement = __commonJS({
  "node_modules/pretty-format/build/plugins/ReactElement.js"(exports) {
    ...
    var serialize2 = (element, config2, indentation, depth, refs, printer) => ++depth > config2.maxDepth ? (0, _markup.printElementAsLeaf)(getType5(element), config2) : (0, _markup.printElement)(
      getType5(element),
      (0, _markup.printProps)(
        getPropKeys(element),
        element.props,
...
${indentationNext}`);
    ...
    function findPlugin(plugins6, val) {
      for (let p = 0; p < plugins6.length; p++) {
        try {
          if (plugins6[p].test(val)) {
            return plugins6[p];
          }
        } catch (error) {
          throw new PrettyFormatPluginError(error.message, error.stack);
    ...
    exports.plugins = plugins5;
    var _default = format6;
    exports.default = _default;
  }
});
...
function truncate(string5, length, tail = truncator) {
  ...
  if (stringLength > length && stringLength > tailLength) {
    return `${string5.slice(0, length - tailLength)}${tail}`;
  }
  return string5;
}
function inspectList(list, options, inspectItem, separator = ", ") {
  ...
  for (let i2 = 0; i2 < size; i2 += 1) {
    ...
    const string5 = peek || inspectItem(value, options) + (last ? "" : separator);
    const nextLength = output.length + string5.length;
...
function inspectTypedArray(array2, options) {
  ...
  for (let i2 = 0; i2 < array2.length; i2++) {
    const string5 = `${options.stylize(truncate(array2[i2], options.truncate), "number")}${i2 === array2.length - 1 ? "" : ", "}`;
    options.truncate -= string5.length;
...
function inspectString(string5, options) {
  if (stringEscapeChars.test(string5)) {
    string5 = string5.replace(stringEscapeChars, escape);
  }
  return options.stylize(`'${truncate(string5, options.truncate - 2)}'`, "string");
}
...
var require_objDisplay = __commonJS({
  "node_modules/chai/lib/chai/utils/objDisplay.js"(exports, module2) {
    ...
    var config2 = require_config();
    module2.exports = function objDisplay3(obj) {
      var str = inspect4(obj), type2 = Object.prototype.toString.call(obj);
...
var require_getMessage = __commonJS({
  "node_modules/chai/lib/chai/utils/getMessage.js"(exports, module2) {
    ...
    var objDisplay3 = require_objDisplay();
    module2.exports = function getMessage(obj, args) {
      ...
      msg = msg.replace(/#\{this\}/g, function() {
        return objDisplay3(val);
      }).replace(/#\{act\}/g, function() {
        return objDisplay3(actual);
      }).replace(/#\{exp\}/g, function() {
        return objDisplay3(expected);
      });
...
var require_compareByInspect = __commonJS({
  "node_modules/chai/lib/chai/utils/compareByInspect.js"(exports, module2) {
    ...
    module2.exports = function compareByInspect(a, b2) {
      return inspect4(a) < inspect4(b2) ? -1 : 1;
    };
  }
});
...
var require_getOperator = __commonJS({
  "node_modules/chai/lib/chai/utils/getOperator.js"(exports, module2) {
    ...
    module2.exports = function getOperator(obj, args) {
      ...
      var isObject6 = isObjectType(expected);
      if (/\snot\s/.test(msg)) {
        return isObject6 ? "notDeepStrictEqual" : "notStrictEqual";
      }
      return isObject6 ? "deepStrictEqual" : "strictEqual";
    };
  }
});
  ...
  "node_modules/magic-string/dist/magic-string.es.mjs"() {
    ...
    MagicString = class _MagicString {
      ...
      _replaceString(string5, replacement) {
        const { original } = this;
        const index2 = original.indexOf(string5);
        if (index2 !== -1) {
          this.overwrite(index2, index2 + string5.length, replacement);
        }
        return this;
      }
      ...
      _replaceAllString(string5, replacement) {
        const { original } = this;
        const stringLength = string5.length;
        for (let index2 = original.indexOf(string5); index2 !== -1; index2 = original.indexOf(string5, index2 + stringLength)) {
...
// node_modules/@vitest/runner/node_modules/@vitest/utils/dist/chunk-display.js
...
// node_modules/@vitest/runner/node_modules/@vitest/utils/dist/chunk-colors.js
...
// node_modules/vitest/node_modules/@vitest/utils/dist/chunk-colors.js
var SAFE_TIMERS_SYMBOL2 = Symbol("vitest:SAFE_TIMERS");
var SAFE_COLORS_SYMBOL2 = Symbol("vitest:SAFE_COLORS");
var colorsMap2 = {
  bold: ["\x1B[1m", "\x1B[22m", "\x1B[22m\x1B[1m"],
  dim: ["\x1B[2m", "\x1B[22m", "\x1B[22m\x1B[2m"],
  italic: ["\x1B[3m", "\x1B[23m"],
...
var colorsEntries2 = Object.entries(colorsMap2);
...
function getSafeTimers2() {
  const {
    ...
    setImmediate: safeSetImmediate,
    clearImmediate: safeClearImmediate
  } = globalThis[SAFE_TIMERS_SYMBOL2] || globalThis;
  const {
    nextTick: safeNextTick
  } = globalThis[SAFE_TIMERS_SYMBOL2] || globalThis.process || { nextTick: (cb) => cb() };
  return {
    nextTick: safeNextTick,
    setTimeout: safeSetTimeout,
    setInterval: safeSetInterval,
...
// node_modules/@vitest/expect/node_modules/@vitest/utils/dist/helpers.js
function assertTypes3(value, name, types) {
  const receivedType = typeof value;
  const pass = types.includes(receivedType);
  if (!pass)
    throw new TypeError(`${name} value must be ${types.join(" or ")}, received "${receivedType}"`);
...
// node_modules/@vitest/expect/node_modules/@vitest/utils/dist/chunk-display.js
...
function stringify2(object2, maxDepth = 10, { maxLength, ...options } = {}) {
  ...
  let result;
  try {
    result = (0, import_pretty_format4.format)(object2, {
      maxDepth,
      escapeString: false,
      // min: true,
      plugins: PLUGINS,
  ...
  return result.length >= MAX_LENGTH && maxDepth > 1 ? stringify2(object2, Math.floor(maxDepth / 2)) : result;
}
...
function format3(...args) {
  if (typeof args[0] !== "string") {
    const objects = [];
    for (let i22 = 0; i22 < args.length; i22++)
      objects.push(inspect3(args[i22], { depth: 0, colors: false, compact: 3 }));
    return objects.join(" ");
  }
  const len = args.length;
  let i2 = 1;
    ...
    switch (x) {
      case "%s": {
        ...
        if (typeof value === "number" && value === 0 && 1 / value < 0)
          return "-0";
        if (typeof value === "object" && value !== null)
          return inspect3(value, { depth: 0, colors: false, compact: 3 });
        return String(value);
      }
      case "%d": {
        const value = args[i2++];
      ...
      case "%f":
        return Number.parseFloat(String(args[i2++])).toString();
      case "%o":
        return inspect3(args[i2++], { showHidden: true, showProxy: true });
      case "%O":
...
// node_modules/@vitest/expect/node_modules/@vitest/utils/dist/chunk-colors.js
var SAFE_TIMERS_SYMBOL3 = Symbol("vitest:SAFE_TIMERS");
var SAFE_COLORS_SYMBOL3 = Symbol("vitest:SAFE_COLORS");
var colorsMap3 = {
  bold: ["\x1B[1m", "\x1B[22m", "\x1B[22m\x1B[1m"],
  dim: ["\x1B[2m", "\x1B[22m", "\x1B[22m\x1B[2m"],
  italic: ["\x1B[3m", "\x1B[23m"],
...
var colorsEntries3 = Object.entries(colorsMap3);
function string3(str) {
  return String(str);
}
string3.open = "";
string3.close = "";
var defaultColors = /* @__PURE__ */ colorsEntries3.reduce((acc, [key]) => {
  acc[key] = string3;
  return acc;
}, { isColorSupported: false });
function getColors() {
  return globalThis[SAFE_COLORS_SYMBOL3] || defaultColors;
}

// node_modules/@vitest/expect/node_modules/@vitest/utils/dist/index.js
var import_pretty_format5 = __toESM(require_build(), 1);
init_loupe();

// node_modules/@vitest/expect/node_modules/@vitest/utils/dist/diff.js
var import_pretty_format6 = __toESM(require_build(), 1);
...
function diff(a, b2, options) {
  ...
  if (expectedType !== getType4(b2)) {
    const { aAnnotation, aColor, aIndicator, bAnnotation, bColor, bIndicator } = normalizeDiffOptions(options);
    const formatOptions = getFormatOptions(FALLBACK_FORMAT_OPTIONS, options);
    const aDisplay = (0, import_pretty_format6.format)(a, formatOptions);
    const bDisplay = (0, import_pretty_format6.format)(b2, formatOptions);
...
function comparePrimitive(a, b2, options) {
  const aFormat = (0, import_pretty_format6.format)(a, FORMAT_OPTIONS);
  const bFormat = (0, import_pretty_format6.format)(b2, FORMAT_OPTIONS);
...
function getObjectsDifference(a, b2, formatOptions, options) {
  ...
  const aCompare = (0, import_pretty_format6.format)(a, formatOptionsZeroIndent);
  const bCompare = (0, import_pretty_format6.format)(b2, formatOptionsZeroIndent);
...
var import_pretty_format7 = __toESM(require_build(), 1);
...
function serializeError(val, seen = /* @__PURE__ */ new WeakMap()) {
  ...
  if (typeof val.asymmetricMatch === "function")
    return `${val.toString()} ${format3(val.sample)}`;
  if (seen.has(val))
    return seen.get(val);
  if (Array.isArray(val)) {
    const clone4 = new Array(val.length);
    seen.set(val, clone4);
    val.forEach((e, i2) => {
      try {
        clone4[i2] = serializeError(e, seen);
      } catch (err) {
        clone4[i2] = getUnserializableMessage(err);
      }
    });
    return clone4;
  } else {
    const clone4 = /* @__PURE__ */ Object.create(null);
    seen.set(val, clone4);
    let obj = val;
    while (obj && obj !== OBJECT_PROTO) {
      Object.getOwnPropertyNames(obj).forEach((key) => {
        if (key in clone4)
          return;
        try {
          clone4[key] = serializeError(val[key], seen);
        } catch (err) {
          delete clone4[key];
          clone4[key] = getUnserializableMessage(err);
        }
      });
...
function getMatcherUtils() {
  ...
  const printReceived = (object2) => RECEIVED_COLOR(replaceTrailingSpaces(stringify2(object2)));
  const printExpected = (value) => EXPECTED_COLOR(replaceTrailingSpaces(stringify2(value)));
  return {
    EXPECTED_COLOR,
    RECEIVED_COLOR,
    INVERTED_COLOR,
...
function isObjectWithKeys(a) {
  return isObject3(a) && !(a instanceof Error) && !Array.isArray(a) && !(a instanceof Date);
}
...
var StringContaining = class extends AsymmetricMatcher4 {
  constructor(sample, inverse = false) {
...
var Anything = class extends AsymmetricMatcher4 {
  asymmetricMatch(other) {
    return other != null;
  }
  toString() {
...
var ObjectContaining = class extends AsymmetricMatcher4 {
  constructor(sample, inverse = false) {
    super(sample, inverse);
  }
  getPrototype(obj) {
...
var ArrayContaining = class extends AsymmetricMatcher4 {
  constructor(sample, inverse = false) {
    super(sample, inverse);
  }
  asymmetricMatch(other) {
...
var Any = class extends AsymmetricMatcher4 {
  constructor(sample) {
...
var StringMatching = class extends AsymmetricMatcher4 {
  constructor(sample, inverse = false) {
...
var JestChaiExpect = (chai3, utils) => {
  ...
  def("toBeGreaterThan", function(expected) {
    const actual = this._obj;
    assertTypes3(actual, "actual", ["number", "bigint"]);
    assertTypes3(expected, "expected", ["number", "bigint"]);
    return this.assert(
      actual > expected,
...
function JestExtendPlugin(expect2, matchers) {
  return (c2, utils) => {
    Object.entries(matchers).forEach(([expectAssertionName, expectAssertion]) => {
      ...
      class CustomMatcher extends AsymmetricMatcher4 {
...
var import_pretty_format8 = __toESM(require_build(), 1);
...
function getCallLastIndex4(code) {
  let charIndex = -1;
  let inString = null;
...
var {
  ...
  DOMElement: DOMElement4,
  Immutable: Immutable4,
  ReactElement: ReactElement4,
  ReactTestComponent: ReactTestComponent4,
  AsymmetricMatcher: AsymmetricMatcher5
} = import_pretty_format8.plugins;
var PLUGINS3 = [
  ReactTestComponent4,
  ReactElement4,
  DOMElement4,
...
function addExtraLineBreaks(string5) {
  return string5.includes("\n") ? `
${string5}
` : string5;
}
function removeExtraLineBreaks(string5) {
  return string5.length > 2 && string5.startsWith("\n") && string5.endsWith("\n") ? string5.slice(1, -1) : string5;
}
var escapeRegex = true;
var printFunctionName = false;
function serialize(val, indent = 2, formatOverrides = {}) {
  return normalizeNewlines(
    (0, import_pretty_format8.format)(val, {
      escapeRegex,
      indent,
...
function normalizeNewlines(string5) {
...
function deepMergeArray(target = [], source = []) {
  ...
  source.forEach((sourceElement, index2) => {
    ...
    } else if (isObject5(targetElement)) {
...
function deepMergeSnapshot(target, source) {
  if (isObject5(target) && isObject5(source)) {
    const mergedOutput = { ...target };
    Object.keys(source).forEach((key) => {
      if (isObject5(source[key]) && !source[key].$$typeof) {
        if (!(key in target))
...
function replaceObjectSnap(code, s, index2, newSnap) {
  ...
  const charIndex = getCallLastIndex4(code);
  if (charIndex === null)
    return false;
...
function waitNextTick() {
  const { setTimeout } = getSafeTimers2();
...
var bench = createBenchmark(
  function(name, fn2 = noop2, options = {}) {
...
var string4 = copyPrototype(String.prototype);
var prototypes = {
  array,
  function: _function,
  map,
...
function createVitest() {
  ...
  return {
    ...
    fn,
    hoisted(factory) {
      assertTypes2(factory, '"vi.hoisted" factory', ["function"]);
      return factory();
    },
    mock(path2, factory) {
...
var InMemoryOrganizationsRepository = class {
  ...
  async register(data) {
    const organization = {
      _id: (0, import_crypto2.randomUUID)(),
      name: data.name,
      location: {
        type: "Point",
        coordinates: [
...
// src/use-cases/fetch-nearby-pets-with-filters.spec.ts
var import_bcryptjs = require("bcryptjs");

// src/use-cases/fetch-nearby-pets-with-filters.ts
var FetchNearbyPetsWithFiltersUseCase = class {
  constructor(organizationsRepository, petsRepository2) {
...
describe("Fetch Nearby Pets With Filters Use Case", () => {
  ...
  it("should be able to fetch nearby pets with filters", async () => {
    ...
    await petsRepository.register({
      ...
      requirementsForAdoption: [
        {
          text: "N\xE3o oferecer chocolate"
        },
        {
          text: "Ter brinquedos"
        }
    ...
    organization = await organizationRepository.register({
      ...
      phone: "19 95566-5886",
      description: "",
      password_hash: await (0, import_bcryptjs.hash)("123455", 6)
    });
    if (!organization._id) {
      throw new Error("Server Error");
    }
    ...
    organization = await organizationRepository.register({
      ...
      phone: "19 95566-5986",
      description: "",
      password_hash: await (0, import_bcryptjs.hash)("123846", 6)
    });
    if (!organization._id) {
      throw new Error("Server Error");
    }
    ...
    globalExpect(filteredPets).toHaveLength(2);
  });
});
