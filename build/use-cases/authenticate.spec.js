...
var AuthenticateUseCase = class {
  constructor(organizationRepository2) {
...
describe("Authenticate Use Case", () => {
  ...
  it("should be able to authenticate", async () => {
    ...
    await organizationRepository.register({
      ...
      email,
      password_hash: await (0, import_bcryptjs2.hash)(password, 6),
      phone: "19 95566-5626",
      description: ""
    });
    const { organization } = await sut.execute({ email, password });
    globalExpect(organization.email).toEqual(globalExpect.any(String));
  });
